...
<br><b>Цель проекта:</b> необходимо выявить определяющие успешность игры закономерности.
Это позволит сделать ставку на потенциально популярный продукт и спланировать рекламные кампании.</br>
<br>Представлены данные до 2016 года. Гипотетически, планируется кампанию на 2017-й. </br>
